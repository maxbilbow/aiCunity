...
struct  ExtendedKeyUsageExtension_t1424  : public X509Extension_t1230
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1161 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1424_StaticFields{
	...
	Dictionary_2_t272 * ___U3CU3Ef__switch$map14_4;
};
