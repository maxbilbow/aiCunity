...
struct  ExtendedKeyUsageExtension_t1422  : public X509Extension_t1228
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1159 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1422_StaticFields{
	...
	Dictionary_2_t270 * ___U3CU3Ef__switch$map14_4;
};
