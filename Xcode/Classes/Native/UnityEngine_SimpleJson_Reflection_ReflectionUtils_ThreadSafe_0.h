...
struct  ThreadSafeDictionary_2_t930  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t929 * ____valueFactory_1;
	...
	Dictionary_2_t3471 * ____dictionary_2;
};
