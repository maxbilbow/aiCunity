...
struct  ThreadSafeDictionary_2_t928  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t927 * ____valueFactory_1;
	...
	Dictionary_2_t3469 * ____dictionary_2;
};
