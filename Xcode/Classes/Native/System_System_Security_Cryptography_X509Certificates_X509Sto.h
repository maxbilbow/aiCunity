...
struct  X509Store_t1226  : public Object_t
{
	...
	X509Certificate2Collection_t1216 * ___list_2;
	...
	X509Store_t1242 * ___store_4;
};
struct X509Store_t1226_StaticFields{
	...
	Dictionary_2_t270 * ___U3CU3Ef__switch$mapF_5;
};
