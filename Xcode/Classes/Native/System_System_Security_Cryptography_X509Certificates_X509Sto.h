...
struct  X509Store_t1228  : public Object_t
{
	...
	X509Certificate2Collection_t1218 * ___list_2;
	...
	X509Store_t1244 * ___store_4;
};
struct X509Store_t1228_StaticFields{
	...
	Dictionary_2_t272 * ___U3CU3Ef__switch$mapF_5;
};
