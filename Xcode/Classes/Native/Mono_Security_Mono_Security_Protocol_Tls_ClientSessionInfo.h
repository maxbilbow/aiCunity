...
struct  ClientSessionInfo_t1449  : public Object_t
{
	...
	ByteU5BU5D_t720* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t720* ___masterSecret_5;
};
struct ClientSessionInfo_t1449_StaticFields{
