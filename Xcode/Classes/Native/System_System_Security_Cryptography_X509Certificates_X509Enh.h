...
struct  X509EnhancedKeyUsageExtension_t1236  : public X509Extension_t1214
{
	...
	OidCollection_t1233 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1236_StaticFields{
	...
	Dictionary_2_t272 * ___U3CU3Ef__switch$mapE_6;
};
