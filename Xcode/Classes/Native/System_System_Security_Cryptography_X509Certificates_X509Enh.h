...
struct  X509EnhancedKeyUsageExtension_t1234  : public X509Extension_t1212
{
	...
	OidCollection_t1231 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1234_StaticFields{
	...
	Dictionary_2_t270 * ___U3CU3Ef__switch$mapE_6;
};
